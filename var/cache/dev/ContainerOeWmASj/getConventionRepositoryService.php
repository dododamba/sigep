 ...
 */
class getConventionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConventionRepository' shared autowired service.
     *
     * @return \App\Repository\ConventionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConventionRepository.php';

        return $container->privates['App\\Repository\\ConventionRepository'] = new \App\Repository\ConventionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
