...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \App\Twig\Extension\PermissionExtension(new \App\Service\PermissionChecker(($container->privates['security.helper'] ?? self::getSecurity_HelperService($container)))));
