 ...
 */
class getUserActivityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserActivityRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserActivityRepository.php';

        return $container->privates['App\\Repository\\UserActivityRepository'] = new \App\Repository\UserActivityRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
