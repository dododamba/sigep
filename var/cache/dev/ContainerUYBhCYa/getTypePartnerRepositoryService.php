 ...
 */
class getTypePartnerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypePartnerRepository' shared autowired service.
     *
     * @return \App\Repository\TypePartnerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypePartnerRepository.php';

        return $container->privates['App\\Repository\\TypePartnerRepository'] = new \App\Repository\TypePartnerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
