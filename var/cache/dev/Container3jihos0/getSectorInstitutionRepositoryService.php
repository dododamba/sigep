 ...
 */
class getSectorInstitutionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SectorInstitutionRepository' shared autowired service.
     *
     * @return \App\Repository\SectorInstitutionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SectorInstitutionRepository.php';

        return $container->privates['App\\Repository\\SectorInstitutionRepository'] = new \App\Repository\SectorInstitutionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
