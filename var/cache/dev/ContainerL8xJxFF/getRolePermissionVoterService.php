...
{
    /**
     * Gets the private '.debug.security.voter.App\Security\Voter\RolePermissionVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'RolePermissionVoter.php';

        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['.debug.security.voter.App\\Security\\Voter\\RolePermissionVoter'])) {
            return $container->privates['.debug.security.voter.App\\Security\\Voter\\RolePermissionVoter'];
        }

        return $container->privates['.debug.security.voter.App\\Security\\Voter\\RolePermissionVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\Voter\RolePermissionVoter(), $a);
    }
}
