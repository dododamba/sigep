 ...
 */
class getAuditRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AuditRepository' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AuditRepository.php';

        return $container->privates['App\\Repository\\AuditRepository'] = new \App\Repository\AuditRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
