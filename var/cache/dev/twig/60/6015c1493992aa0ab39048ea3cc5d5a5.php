...
class __TwigTemplate_d3dd07d38f7c6e418f8faf3e451ec6bc extends Template
{
    ...
    <div class=\"container\">
        ...
        yield "\">Accueil</a>
                            ...
                            <li class=\"breadcrumb-item active\" aria-current=\"page\">Devenez volontaire</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class=\"p-5\">
                    ...
                    <hr>
                     ...
                     <div class=\"text-center\">
                        <a class=\"small\" href=\"";
        // line 73
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_register_as_partner");
        yield "\"> S'inscrire en tant partenaire!</a>
                    </div>
...
";
    ...
    {
        return array (  164 => 77,  157 => 73,  101 => 20,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
{% block title %}Devenez volontaire{% endblock %}
            ...
            <div class=\"col-lg-7\">
                <div class=\"p-5\">
                    ...
                    <hr>
                     ...
                     <div class=\"text-center\">
                        <a class=\"small\" href=\"{{path('app_register_as_partner')}}\"> S'inscrire en tant partenaire!</a>
                    </div>
...
{% endblock %}
", "security/register.html.twig", "/home/xdevcorp/Projects/sigep/templates/security/register.html.twig");
    }
}
