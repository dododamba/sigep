...
class __TwigTemplate_5caba208ebc8a31b1dd00dbfa8631937 extends Template
{
    ...
    public function block_toolbar(array $context, array $blocks = []): iterable
    {
        ...
        // line 39
        yield from $this->load("@WebProfiler/Profiler/toolbar_item.html.twig", 39)->unwrap()->yield(CoreExtension::merge($context, ["link" => (isset($context["profiler_url"]) || array_key_exists("profiler_url", $context) ? $context["profiler_url"] : (function () { throw new RuntimeError('Variable "profiler_url" does not exist.', 39, $this->source); })())]));
    ...
    <div class=\"sf-tabs\">
        ...
        yield " listeners)
            ...
            <div class=\"tab-content\">
                ...
                <div id=\"jms-events\">";
        // line 133
        yield from $this->load("@JMSSerializer/Collector/events.html.twig", 133)->unwrap()->yield($context);
        // line 134
        yield "</div>
            </div>
        </div>
        ...
        yield " types)
            ...
            <div class=\"tab-content\">
                ...
                <div id=\"jms-handlers\">";
        // line 151
        yield from $this->load("@JMSSerializer/Collector/handlers.html.twig", 151)->unwrap()->yield($context);
        // line 152
        yield "</div>
            </div>
        </div>
        ...
        yield "</span>
            ...
            <div class=\"tab-content\">
                ...
                <div id=\"jms-metadata\">";
        // line 168
        yield from $this->load("@JMSSerializer/Collector/metadata.html.twig", 168)->unwrap()->yield($context);
        // line 169
        yield "</div>
            </div>
        </div>
    ...
    {
        return array (  441 => 190,  433 => 187,  430 => 186,  426 => 185,  416 => 178,  414 => 177,  398 => 175,  387 => 169,  385 => 168,  377 => 161,  375 => 160,  372 => 159,  363 => 152,  361 => 151,  351 => 143,  347 => 142,  337 => 134,  335 => 133,  323 => 123,  319 => 122,  309 => 115,  305 => 114,  297 => 109,  290 => 105,  282 => 100,  275 => 96,  269 => 92,  263 => 90,  261 => 89,  257 => 87,  247 => 86,  233 => 80,  228 => 77,  222 => 75,  220 => 74,  213 => 70,  207 => 68,  204 => 67,  194 => 65,  186 => 62,  181 => 60,  162 => 44,  159 => 43,  149 => 42,  141 => 39,  133 => 35,  126 => 31,  119 => 27,  112 => 23,  105 => 19,  101 => 17,  99 => 16,  91 => 12,  89 => 11,  85 => 10,  80 => 8,  75 => 6,  73 => 5,  63 => 3,  55 => 1,  53 => 2,  43 => 1,);
    }
...
{%- macro render_table_runs(runs, mode) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/panel.html.twig", "/home/xdevcorp/Projects/sigep/vendor/jms/serializer-bundle/Resources/views/Collector/panel.html.twig");
    }
}
