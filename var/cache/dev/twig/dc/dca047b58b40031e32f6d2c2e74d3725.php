...
class __TwigTemplate_ccbf1ee6a4d5dfde994ea0dda16fcfc6 extends Template
{
...
<aside class=\"sidebar\" :class=\"{ 'open': sidebarOpen }\">
    ...
    <nav class=\"sidebar-nav\">
        ...
        yield "\"
               class=\"nav-item ";
        // line 69
        yield (((is_string($_v10 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 69, $this->source); })())) && is_string($_v11 = "app_decaissement_index") && str_starts_with($_v10, $_v11))) ? ("active") : (""));
        yield "\">
                <i class=\"ri-bank-line\"></i>
        ...
        yield "\"
            class=\"nav-item ";
        // line 75
        yield (((is_string($_v12 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 75, $this->source); })())) && is_string($_v13 = "app_convention") && str_starts_with($_v12, $_v13))) ? ("active") : (""));
        yield "\">
        ...
        yield "\"
            class=\"nav-item ";
        // line 81
        yield (((is_string($_v14 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 81, $this->source); })())) && is_string($_v15 = "app_audit") && str_starts_with($_v14, $_v15))) ? ("active") : (""));
        yield "\">
                <i class=\"ri-file-list-3-line\"></i>
                <span>Audits</span>
            </a>
        ...
        <div class=\"nav-section\">
            ...
            <a href=\"#\"
               class=\"nav-item ";
        // line 92
        yield ((((is_string($_v16 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 92, $this->source); })())) && is_string($_v17 = "app_roles") && str_starts_with($_v16, $_v17)) || (is_string($_v18 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 92, $this->source); })())) && is_string($_v19 = "app_login_history") && str_starts_with($_v18, $_v19)))) ? ("active") : (""));
        yield "\">
        ...
        yield "\"
                   class=\"nav-item ";
        // line 98
        yield (((is_string($_v20 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 98, $this->source); })())) && is_string($_v21 = "app_roles") && str_starts_with($_v20, $_v21))) ? ("active") : (""));
        yield "\">
        ...
        yield "\"
                   class=\"nav-item ";
        // line 104
        yield (((is_string($_v22 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 104, $this->source); })())) && is_string($_v23 = "app_login_history") && str_starts_with($_v22, $_v23))) ? ("active") : (""));
        yield "\">
        ...
        yield "\"
               class=\"nav-item ";
        // line 120
        yield (((is_string($_v24 = (isset($context["currentRoute"]) || array_key_exists("currentRoute", $context) ? $context["currentRoute"] : (function () { throw new RuntimeError('Variable "currentRoute" does not exist.', 120, $this->source); })())) && is_string($_v25 = "app_profile") && str_starts_with($_v24, $_v25))) ? ("active") : (""));
        yield "\">
...
";
    ...
    {
        return array (  244 => 125,  236 => 120,  232 => 119,  214 => 104,  210 => 103,  202 => 98,  198 => 97,  190 => 92,  176 => 81,  172 => 80,  164 => 75,  160 => 74,  152 => 69,  148 => 68,  140 => 63,  136 => 62,  128 => 57,  124 => 56,  111 => 46,  107 => 45,  99 => 40,  95 => 39,  87 => 34,  83 => 33,  53 => 6,  47 => 2,  45 => 1,);
    }
...
", "partials/sidebare.html.twig", "/home/xdevcorp/Projects/sigep/templates/partials/sidebare.html.twig");
    }
}
