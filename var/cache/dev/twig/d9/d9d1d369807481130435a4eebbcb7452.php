...
/* user/show.html.twig */
class __TwigTemplate_80710f604b1268ce67405964ba51720c extends Template
{
            ...
            yield "                <div class=\"info-item\">
                    ...
                    <div class=\"info-content\">
                        ...
                        <div class=\"info-value\">
                            ";
            // line 423
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 423, $this->source); })()), "institution", [], "any", false, false, false, 423), "name", [], "any", false, false, false, 423), "html", null, true);
            yield "
                            ";
            // line 424
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 424, $this->source); })()), "institution", [], "any", false, false, false, 424), "acronym", [], "any", false, false, false, 424)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 425
                yield "                                <span class=\"badge bg-secondary\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 425, $this->source); })()), "institution", [], "any", false, false, false, 425), "acronym", [], "any", false, false, false, 425), "html", null, true);
                yield "</span>
                            ";
            }
            // line 427
                    ...
                    <div class=\"info-content\">
                        ...
                        <div class=\"info-value\">
                            ...
                            {% if user.institution.acronym %}
                                <span class=\"badge bg-secondary\">{{ user.institution.acronym }}</span>
                            {% endif %}
                        </div>
                    </div>
                </div>
