...
/* dashboard/_project_details.html.twig */
class __TwigTemplate_cbdbc06ab9d0db0f64fb4d63be67dd6b extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashboard/_project_details.html.twig"));
        ...
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["financingDetails"]) || array_key_exists("financingDetails", $context) ? $context["financingDetails"] : (function () { throw new RuntimeError('Variable "financingDetails" does not exist.', 135, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["financing"]) {
                ...
                yield "                                </div>
                                <a href=\"";
                // line 149
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_dashboard_financing_detail", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["financing"], "id", [], "any", false, false, false, 149)]), "html", null, true);
...
";
    ...
    {
        return "dashboard/_project_details.html.twig";
    }
                    ...
                    {% if financingDetails is not empty %}
                        <div class=\"financing-list\">
                            ...
                            <div class=\"financing-item\">
                                ...
                                <a href=\"{{ path('app_dashboard_financing_detail', {id: financing.id}) }}\" class=\"financing-link\">
                                    Voir détails
                                    <i data-lucide=\"arrow-right\"></i>
                                </a>
                            </div>
...
{% endblock %}
", "dashboard/_project_details.html.twig", "C:\\Users\\LENOVO\\Documents\\Dominique\\Projects\\SIGEP\\templates\\dashboard\\_project_details.html.twig");
    }
}
