 ...
 */
class getDecaissementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DecaissementRepository' shared autowired service.
     *
     * @return \App\Repository\DecaissementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DecaissementRepository.php';

        return $container->privates['App\\Repository\\DecaissementRepository'] = new \App\Repository\DecaissementRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
