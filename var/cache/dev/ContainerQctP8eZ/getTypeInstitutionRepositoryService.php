 ...
 */
class getTypeInstitutionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeInstitutionRepository' shared autowired service.
     *
     * @return \App\Repository\TypeInstitutionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeInstitutionRepository.php';

        return $container->privates['App\\Repository\\TypeInstitutionRepository'] = new \App\Repository\TypeInstitutionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
