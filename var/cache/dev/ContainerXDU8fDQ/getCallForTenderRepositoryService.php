 ...
 */
class getCallForTenderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CallForTenderRepository' shared autowired service.
     *
     * @return \App\Repository\CallForTenderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CallForTenderRepository.php';

        return $container->privates['App\\Repository\\CallForTenderRepository'] = new \App\Repository\CallForTenderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
