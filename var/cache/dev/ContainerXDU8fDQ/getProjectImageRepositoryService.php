 ...
 */
class getProjectImageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectImageRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectImageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectImageRepository.php';

        return $container->privates['App\\Repository\\ProjectImageRepository'] = new \App\Repository\ProjectImageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
