...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/AuditFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ConventionFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/InstitutionFixtures.php';
