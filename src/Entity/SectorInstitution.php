...
#[ORM\Entity(repositoryClass: SectorInstitutionRepository::class)]
class SectorInstitution
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     */
    #[ORM\OneToMany(targetEntity: Institution::class, mappedBy: 'sector')]
    ...
    public function removeInstitution(Institution $institution): static
    {
        if ($this->institutions->removeElement($institution)) {
            if ($institution->getSector() === $this) {
                $institution->setSector(null);
            }
        }
        return $this;
    }
